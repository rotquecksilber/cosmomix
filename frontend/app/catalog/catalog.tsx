      ...
      <div className={styles.page}>
          ...
          <ul className={styles.list}>
            {[
              ...
              },
              {
                ...
                description: 'Матовая помада с долгой фиксацией, насыщенный цвет и бархатистая текстура.'
              },
              {
                title: 'Матовая помада blur',
                description: 'Помада с эффектом размытого контура, мягкая матовая текстура и комфортное нанесение.'
              }
            ].map((item) => (
              <li key={item.title}>
        ...
        <section className={styles.section} aria-labelledby="stick-lips">
          ...
          <ul className={styles.list}>
            {[
              ...
              {
                title: 'Помада блюр',
                description: 'Помада с эффектом размытого контура делает губы мягкими и естественными.'
              },
              {
                title: 'Помада увлажняющая',
                description: 'Увлажняющая помада питает губы, делает их мягкими и блестящими.'
              },
              {
                title: 'Помада глянцевая',
        ...
        <section className={styles.section} aria-labelledby="eyes">
          ...
          <ul className={styles.list}>
            {[
              {
                title: 'Тушь классическая',
                description: 'Классическая тушь удлиняет и подкручивает ресницы, создавая естественный объем.'
              },
              {
                title: 'Тушь термо',
                description: 'Термоустойчивая тушь сохраняет форму ресниц даже при высокой температуре.'
              },
              {
                title: 'Тушь водостойкая',
                description: 'Водостойкая тушь не смазывается и держится весь день, даже при контакте с водой.'
              },
              {
                title: 'Подводка в баночке',
                description: 'Кремовая подводка легко наносится и создаёт чёткие линии с насыщенным цветом.'
              },
              {
              ...
              {
                title: 'Кремовые тени',
                description: 'Кремовые тени легко растушёвываются, дают насыщенный цвет и стойкость.'
              },
              {
        ...
        <section className={styles.section} aria-labelledby="face">
          ...
          <ul className={styles.list}>
            {[
              ...
              {
                title: 'База под макияж затирка пор силиконовая',
                description: 'Сглаживает поры и обеспечивает ровную поверхность для макияжа.'
              },
              {
                title: 'База под макияж увлажняющая',
                description: 'Увлажняет и подготавливает кожу к нанесению косметики.'
              },
              {
                title: 'База под макияж цветная',
                description: 'Выравнивает тон кожи и добавляет лёгкий оттенок.'
              },
              {
                title: 'Пудра для лица рассыпчатая прозрачная',
                description: 'Закрепляет макияж, матирует и фиксирует тон.'
              },
              ...
              {
                title: 'Гидрофильный бальзам жидкий',
                description: 'Растворяет макияж и загрязнения, увлажняет кожу.'
              },
              {
                title: 'Гидрофильный бальзам в твердом формате',
                description: 'Комфортно очищает кожу, легко наносится и смывается.'
              }
            ].map((item) => (
              <li key={item.title}>
                <span className={styles.itemTitle}>{item.title}</span>
