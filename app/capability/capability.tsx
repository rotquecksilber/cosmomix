        ...
        <div className={styles.grid}>
          ...
          <article className={styles.card}>
            ...
            <ul className={styles.cardList}>
              ...
              <li>
                Разработка и производство запечённой косметики по итальянской технологии — хайлайтеров, скульпторов, бронзеров, румян и пудр, с запеканием на керамических плитах.
              </li>
            </ul>
          </article>
