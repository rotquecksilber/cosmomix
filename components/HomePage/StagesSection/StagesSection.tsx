    ...
    <section className={styles.stages} aria-labelledby="stages-heading">
      ...
      <div className={styles.desktopVersion}>
        <div className={styles.stages_wrapper}>
          ...
          <Image alt={'Линия под этапами'} src={'/home_page/stages_line.webp'} height={7} width={995} />
        </div>
        <Image alt={'Этапы сотрудничества'} src={'/home_page/stages_photo.webp'} width={1260} height={1860} className={styles.stages_photo} />
      </div>

      {/* --- MOBILE --- */}
      <div className={styles.mobileVersion}>
        <Image alt={'Этапы сотрудничества'} src={'/home_page/stages_photo.webp'} width={900} height={1200} className={styles.stages_photo_mobile} />
